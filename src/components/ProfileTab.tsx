  ...
  return (
    <div className="p-4">
      ...
      {plan && (
        <>
          ...
          <div className="bg-teal-50 rounded-xl p-3 mb-4">
            ...
            {plan.meal_plan_base && <p className="text-xs text-teal-600">{plan.meal_plan_base.meals_per_day || 5} refeições/dia — {plan.meal_plan_base.calories} kcal</p>}
          </div>
        </>
      )}
      ...
      <button
        ...
        className="w-full mt-6 py-3 border border-gray-200 rounded-xl text-sm text-gray-500"
      >
        Sair da conta
      </button>
    </div>
